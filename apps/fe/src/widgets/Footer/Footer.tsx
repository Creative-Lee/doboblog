  ...
  return (
    <footer className="w-full border-t border-[var(--color-border)] bg-[var(--color-background)]">
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <div className="flex flex-col items-center gap-2 md:items-start">
            <Link href="/" className="flex items-center gap-2 transition-opacity hover:opacity-80">
              ...
              <span className="font-bold">doboblog</span>
            </Link>
            <Typography variant="muted" className="text-sm">
              © {currentYear} doboblog. All rights reserved.
            </Typography>
          </div>
          ...
          <div className="flex gap-6">
            ...
            <a
              href="mailto:contact@doboblog.com"
              className="text-[var(--color-muted-foreground)] transition-colors hover:text-[var(--color-foreground)]"
              aria-label="Email"
            >
              <svg
        ...
        {/* 추가 정보 */}
        <div className="mt-6 flex flex-wrap justify-center gap-4 border-t border-[var(--color-border)] pt-6 md:justify-start">
          <Link
            href="/"
